...
export default function Projects() {
  return (
    <>
      ...
      <main className="relative min-h-screen flex items-center justify-center pt-23 fade-up overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl px-6 text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10">
            ...
            {/* Project – Calculator */}
            <div className="bg-white/70 dark:bg-[#2f284b] rounded-xl shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-2 w-[90%] md:w-80 flex flex-col">
